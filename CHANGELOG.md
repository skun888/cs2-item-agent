...
- 更新公开发布状态、Agent 快速开始和项目进度说明；
- 明确 Trae 已通过实机验收，其余目标客户端当前为项目级兼容配置；
- 使用已修复版本覆盖 MCP SDK 间接依赖中的 Hono Windows 静态文件服务漏洞；
- 增加贡献指南、安全策略和发布前依赖安全审计要求。

## 0.8.0-alpha.1 - 2026-07-22

首个公开、可回滚的 GitHub 源码预发布版本。
...
- 已通过 GitHub Releases 交付源代码，尚未发布 npm 包、预编译程序或 Docker 镜像；
